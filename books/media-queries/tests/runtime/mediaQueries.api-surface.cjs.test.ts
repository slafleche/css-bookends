...
const cjsMediaQueries = await import('../../dist/cjs/index.js');
...
describe('mediaQueries API surface (CJS)', () => {
  it('exposes expected media queries helpers', () => {
    ...
    expect(typeof cjsMediaQueries.buildMediaQueryString).toBe(
      'function',
    );

    expect(cjsMediaQueries).toHaveProperty('makeMediaQueryStyle');
    expect(typeof cjsMediaQueries.makeMediaQueryStyle).toBe(
      'function',
    );

    expect(cjsMediaQueries).toHaveProperty('createMediaQueryBuilder');
    expect(typeof cjsMediaQueries.createMediaQueryBuilder).toBe(
      'function',
    );
    ...
    expect(typeof cjsMediaQueries.buildMediaQueryFromFeatures).toBe(
      'function',
    );
    ...
    expect(
      typeof cjsMediaQueries.buildMediaQueryStringFromParts,
    ).toBe('function');
    ...
    expect(
      typeof cjsMediaQueries.createMediaQueryFeatureEmitter,
    ).toBe('function');
    ...
    expect(
      typeof cjsMediaQueries.createMediaQueryFeatureEmitterWithTracking,
    ).toBe('function');
    ...
    expect(typeof cjsMediaQueries.defineMediaQueryModules).toBe(
      'function',
    );
    ...
    expect(
      typeof cjsMediaQueries.mediaQueryOutputVanillaExtract,
    ).toBe('function');
    expect(cjsMediaQueries).toHaveProperty('outputVanillaExtract');
    expect(typeof cjsMediaQueries.outputVanillaExtract).toBe(
      'function',
    );
  });
  ...
  it('exposes media query module emitters', () => {
    ...
    expect(typeof cjsMediaQueries.emitDimensionsFeatures).toBe(
      'function',
    );

    expect(cjsMediaQueries).toHaveProperty('emitResolutionFeatures');
    expect(typeof cjsMediaQueries.emitResolutionFeatures).toBe(
      'function',
    );

    expect(cjsMediaQueries).toHaveProperty('emitInteractionFeatures');
    expect(typeof cjsMediaQueries.emitInteractionFeatures).toBe(
      'function',
    );

    expect(cjsMediaQueries).toHaveProperty('emitPreferencesFeatures');
    expect(typeof cjsMediaQueries.emitPreferencesFeatures).toBe(
      'function',
    );

    expect(cjsMediaQueries).toHaveProperty('emitDisplayFeatures');
    expect(typeof cjsMediaQueries.emitDisplayFeatures).toBe(
      'function',
    );

    expect(cjsMediaQueries).toHaveProperty('emitEnvironmentFeatures');
    expect(typeof cjsMediaQueries.emitEnvironmentFeatures).toBe(
      'function',
    );

    expect(cjsMediaQueries).toHaveProperty('emitCustomFeatures');
    expect(typeof cjsMediaQueries.emitCustomFeatures).toBe(
      'function',
    );
  });
});
